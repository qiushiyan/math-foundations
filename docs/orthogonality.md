...
$$
\begin{split}
\nabla_{x}(\boldsymbol{x}^TA^TA\boldsymbol{x} - 2A\boldsymbol{x}\boldsymbol{b} + \boldsymbol{b}^T\boldsymbol{b}) &=\nabla_x(\boldsymbol{x}^TA^TA\boldsymbol{x}) - \nabla_x{2\boldsymbol{b}^TA\boldsymbol{x}} + \nabla_x{\boldsymbol{b}^T\boldsymbol{b}} \\
&= 2(A^TA)\boldsymbol{x} - 2A^T\boldsymbol{b}
