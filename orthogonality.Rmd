...
```{r, echo = FALSE, fig.cap="figure from page p342, ch6 [@lay2006-3]  "}
knitr::include_graphics("images/orthogonal-projection.png")
```
...
The next question is, how to find $\boldsymbol{y}$?. 
...
```{r, echo = FALSE, fig.cap="figure from page p352, ch6 [@lay2006-3]  "}
